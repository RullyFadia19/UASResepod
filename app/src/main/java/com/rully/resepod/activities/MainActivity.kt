...
class MainActivity : AppCompatActivity(), MainAdapter.onSelectData {
    ...
    var mainAdapter: MainAdapter? = null//buat manggil kelas
    var progressDialog: ProgressDialog? = null
    var modelMain: MutableList<ModelMain> = ArrayList()//buat manggil kelas
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Methods get data // untuk menampilkan katagori yg didepan
        categories
    }
...
//untuk menampilkan fungsi atau data dari mainAdapter
